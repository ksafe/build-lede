...
wget -qc http://clash.ksafe.cn/dler.yaml -P OpenClash/luci-app-openclash/files/etc/openclash/config/
wget -qc http://clash.ksafe.cn/dler-ss.yaml -P OpenClash/luci-app-openclash/files/etc/openclash/config/
wget -qc http://clash.ksafe.cn/dler-trojan.yaml -P OpenClash/luci-app-openclash/files/etc/openclash/config/
wget -qc http://clash.ksafe.cn/dler-v2Ray.yaml -P OpenClash/luci-app-openclash/files/etc/openclash/config/
wget -qc http://clash.ksafe.cn/jms.yaml -P OpenClash/luci-app-openclash/files/etc/openclash/config/
wget -qc http://clash.ksafe.cn/renzhe.yaml -P OpenClash/luci-app-openclash/files/etc/openclash/config/
echo "
